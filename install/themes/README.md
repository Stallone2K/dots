...
Themes are a core part of this setup.

## Installation

```bash
git clone https://github.com/Stallone2K/dotfiles.git ~/dotfiles
...
Wallpapers: [Stallone2K/wallpapers](https://github.com/Stallone2K/wallpapers)
...
The theme engine updates `~/.config/symphony/current` and runs hooks to reload apps. No files are overwritten.
...
- Report a bug: [new bug](https://github.com/Stallone2K/dotfiles/issues/new?template=bug_report.yml)
- Request a feature: [new feature](https://github.com/Stallone2K/dotfiles/issues/new?template=feature_request.yml)
